						  ...
						  const size_t numBins)
{
	...
	//Step 3
	//next we use the now known range to compute a histogram of numBins bins
	...
	//Step 4
	//finally we perform and exclusive scan (prefix sum) on the histogram to get the cumulative distribution
	h_cdf[0] = 0;
